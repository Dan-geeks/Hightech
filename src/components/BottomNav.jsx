...
const BottomNav = () => {
  const whatsappNumber = '254726809609'; // Kenya format: +254
  const email = 'hightechengineering609@gmail.com';
  const phone = '+254 726 809 609';
    ...
    <footer className="bottom-section">
      <div className="footer-container">
        ...
        <div className="footer-column">
          <h3 className="footer-heading">Hightech Engineering</h3>
          <p className="footer-description">
            Professional CNC machining, laser cutting, and DXF design services.
            We deliver precision engineering solutions with instant digital downloads
            and custom fabrication services across Kenya.
          </p>
          <div className="footer-badges">
            <span className="footer-badge">⚡ Fast Delivery</span>
            <span className="footer-badge">🔒 Secure Payment</span>
            <span className="footer-badge">🛠️ Expert Support</span>
          </div>
        </div>
        ...
        <div className="footer-column">
          ...
          <nav className="footer-links">
            ...
            <Link to="/marketplace" className="footer-link">DXF Marketplace</Link>
            <Link to="/design-services" className="footer-link">Design Services</Link>
        ...
        <div className="footer-column">
          ...
          <div className="footer-contact-info">
            ...
            <a href={`https://wa.me/${whatsappNumber}`} className="footer-contact-item" target="_blank" rel="noopener noreferrer">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-container">
          <p>&copy; {new Date().getFullYear()} Hightech Engineering. All rights reserved.</p>
          <div className="footer-legal-links">
            <Link to="/privacy" className="footer-legal-link">Privacy Policy</Link>
            <span className="footer-separator">•</span>
            <Link to="/terms" className="footer-legal-link">Terms of Service</Link>
            <span className="footer-separator">•</span>
            <Link to="/refund" className="footer-legal-link">Refund Policy</Link>
          </div>
        </div>
      </div>
    </footer>
